...
![GitHub commit activity](https://img.shields.io/github/commit-activity/m/Maaack/Godot-Minimal-Game-Template)
...
[Basic Setup](/addons/maaacks_game_template/docs/BasicSetup.md) is done through the setup wizard at **Project > Tools > Run Maaack's Minimal Game Template Setup...**.  
